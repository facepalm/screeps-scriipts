...
var updateRoom = function(room){
    //recomputes strategic stuff, building to be built, energy usage, etc
    
    /*Re-establish tech levels.  Issue build checks.*/
    var cont_lvl = 0;
    if (room.controller){
        cont_lvl = room.controller.level;
    }
...
var controllerRoom = {
    ...
    run: function(room) {
        ...
        //we want to do this every turn, to alert us immediately
        var hostile_hits = 0;
